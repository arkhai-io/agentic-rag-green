...
from agentic_rag.components.converters.markitdown_pdf_converter import MarkItDownPDFToDocument
...
class TestMarkItDownPDFToDocument:
    ...
    def test_markitdown_initialization_import_error(self):
        ...
        with patch('builtins.__import__') as mock_import:
            ...
            with pytest.raises(ImportError, match="MarkItDown library is not installed"):
                converter._initialize_markitdown()
    ...
    def test_convert_pdf_with_markitdown_success(self):
        ...
        try:
            ...
            assert len(result) > 0
            print(f"✅ MarkItDown conversion successful: {len(result)} characters extracted")
    ...
    def test_run_multiple_sources(self):
        ...
        try:
            ...
            print(f"✅ Multiple sources test passed - converted {len(result['documents'])} PDFs")
